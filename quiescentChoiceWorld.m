function quiescentChoiceWorld(t, evts, pars, visStim, in, out, audio)
...
preStimPeriod = p.preStimQuiescentPeriod.at(evts.newTrial).map(@rnd.uni);
stimulusOn = sig.subthresholdEpoch(evts.newTrial, wheel, 1, t, preStimPeriod);
