function lewieWorld2AFC(t, evts, p, vs, in, out, audio)

% Burgess 2AFC task with contrast discrimination and baited equal contrast
% trial conditions. Same as advancedLWChoiceWorld as of 2018-01-24
% 2017-03-25 Added contrast discrimination (MW)
% 2017-08    Added baited trials (thanks PZH)
% 2017-09-26 Added manual reward key presses (MW)
% 2017-10-26 p.wheelGain now in mm/deg units (MW)
% 2017-11-23 Added water-reward bias (LW)
% 2018-01-23 Implemented preStim and interactiveOn quiescence periods (random duration)
% 2018-01-24 Converted to 2AFC, added comments
