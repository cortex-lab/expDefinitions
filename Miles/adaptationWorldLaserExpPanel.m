classdef adaptationWorldLaserExpPanel < eui.ExpPanel
  ...
  methods
    function obj = adaptationWorldLaserExpPanel(parent, ref, params, logEntry)
    ...
    function expUpdate(obj, rig, evt)
      ...
      switch type
        case 'signals' %queue signal updates
          ...
          azimuth = obj.Parameters.Struct.targetAzimuth;
...
%       obj.InfoGrid.ColumnSizes = [150, -1];
      ...
      obj.ExperimentAxes.XLim = [-obj.Parameters.Struct.targetAzimuth...
          obj.Parameters.Struct.targetAzimuth];
